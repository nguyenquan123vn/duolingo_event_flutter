...
void main() {
  ...
  test('An username contains special characters return no error', () {
    var username = EmailPasswordFieldValidator.usernameValidate('__Du0ling0__');
  ...
  test('An email that doesnt have dot domain return error string', () {
    var email = EmailPasswordFieldValidator.emailValidate('duolingo@gmailcom');
    expect(email, 'Please enter a valid email address.');
  });

  test('An email that contains special characters return error string', () {
    var email = EmailPasswordFieldValidator.emailValidate('du-li?go@gmail*com');
    expect(email, 'Please enter a valid email address.');
  });

  test('An email that contains @ and . return no error', () {
    var email = EmailPasswordFieldValidator.emailValidate('duolingo@somewhere.com');
    expect(email, null);
  });
  ...
  test('A password contains spaces, special characters, upperCase return no error', () {
    var password = EmailPasswordFieldValidator.passwordValidate('This psswd 1S c0mp|!C@ted.');
